    ...
    @section('content')
        <div class="container my-5">
                ...
                <form action="/updatepok/{{$pokemons->id}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="row  ">
                        <div class="pb-3">
                            <input class="form-control " style="background: transparent;border:none;" type="text" name="name" placeholder="name" value="{{$pokemons->name}}">
                        </div>
                        <div class="pb-3">
                        ...
                        <div class="pb-3">
                            <div width="10% " class="mb-2">
                                <img width="10%" class="rounded-pill" src="{{asset('storage/img/'.$pokemons->img)}}" alt="">
                            </div>
                            <input class="form-control " style="background: transparent;border:none;"type="file" name="img" placeholder="img">
                        </div>
                        <div class="pb-3">
                            <input class="form-control " style="background: transparent;border:none;"type="number" name="niveau" placeholder="1-100" value={{$pokemons->niveau}}>
                        </div>
                    </div>
